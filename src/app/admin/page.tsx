  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {/* Card 1: Students */}
        <div className="bg-slate-700 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 border-l-4 border-slate-500">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-slate-200 text-sm font-medium uppercase tracking-wide">Students</p>
          ...
          <Link href="/admin/students" className="mt-4 inline-flex items-center text-sm font-semibold text-slate-200 hover:text-white transition-colors">
        ...
        {/* Card 2: Exams */}
        <div className="bg-gray-700 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 border-l-4 border-gray-500">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-200 text-sm font-medium uppercase tracking-wide">Active Exams</p>
          ...
          <Link href="/admin/exams" className="mt-4 inline-flex items-center text-sm font-semibold text-gray-200 hover:text-white transition-colors">
        ...
        {/* Card 3: Classrooms */}
        <div className="bg-stone-700 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 border-l-4 border-stone-500">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-stone-200 text-sm font-medium uppercase tracking-wide">Classrooms</p>
              <p className="text-4xl font-bold mt-2">-</p>
            </div>
            <div className="bg-stone-600 rounded-xl p-3">
              <svg className="h-8 w-8 text-stone-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
            </div>
          </div>
          <Link href="/admin/classrooms" className="mt-4 inline-flex items-center text-sm font-semibold text-stone-200 hover:text-white transition-colors">
        ...
        {/* Card 4: Quick Action */}
        <Link href="/admin/exams" className="bg-gradient-to-br from-[#123b71] to-[#1a5490] rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all hover:scale-105 duration-200 flex flex-col items-center justify-center text-center group border-l-4 border-[#0d2a4d]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg ring-1 ring-gray-200 overflow-hidden">
          <div className="bg-slate-700 px-6 py-4 flex items-center justify-between border-b-2 border-slate-600">
            <h2 className="text-lg font-bold text-white uppercase tracking-wide">Recent Students</h2>
            <Link href="/admin/students" className="text-sm font-semibold text-slate-200 hover:text-white transition-colors inline-flex items-center">
              View All <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            </Link>
          </div>
            ...
            {recentStudents?.map((student: any) => (
              <li key={student.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-center space-x-3">
                  <div className="shrink-0 h-10 w-10 rounded-lg bg-slate-700 flex items-center justify-center text-white font-semibold text-sm shadow-sm">
        ...
        {/* Recent Exams */}
        <div className="bg-white rounded-2xl shadow-lg ring-1 ring-gray-200 overflow-hidden">
          <div className="bg-gray-700 px-6 py-4 flex items-center justify-between border-b-2 border-gray-600">
            <h2 className="text-lg font-bold text-white uppercase tracking-wide">Recent Exams</h2>
            <Link href="/admin/exams" className="text-sm font-semibold text-gray-200 hover:text-white transition-colors inline-flex items-center">
              View All <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            </Link>
          </div>
          <ul role="list" className="divide-y divide-gray-200">
