  ...
  return (
    <footer className="h-16 bg-white border-t border-gray-200 flex items-center justify-between px-6 relative z-20">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2">
        <div className="bg-black text-white px-4 py-1.5 rounded-full text-sm font-medium flex items-center space-x-2 shadow-lg">
      ...
      <div className="flex space-x-3">
        <button 
          onClick={onBack}
          className="px-6 py-2 rounded-full bg-indigo-500 text-white font-sans font-medium text-sm hover:bg-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm transition-colors"
