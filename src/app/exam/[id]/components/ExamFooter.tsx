    ...
    <>
      ...
      >
        ...
        <div className="flex items-center space-x-3 w-1/4">
            <div className="font-bold text-[14px] text-gray-500 font-serif" style={{ 
        ...
        <div className="bg-black text-white p-2 flex items-center gap-2 rounded-xl cursor-pointer" 
             ...
             style={{
                ...
                fontSize: '15px',
                boxSizing: 'content-box' // ensure padding doesn't shrink content
             }}>
             <p className="text-white whitespace-nowrap" style={{ fontSize: '15px' }}>Question {currentQuestionInModule} of {moduleQuestions.length}</p>
        ...
        {isModalOpen && (
            <div className="absolute bottom-full mb-4 w-[600px] bg-white rounded-xl shadow-2xl border border-gray-200 p-6 z-50 transform left-1/2 -translate-x-1/2">
                {/* Pointer */}
